...
| Trait  |        BP |    CARDIO | ADIPOSITY |  GLYCEMIC |      RENAL |      LIPID |
| ------ | --------: | --------: | --------: | --------: | ---------: | ---------: |
| A1C    |         0 |         0 |         0 | **0.630** |          0 |          0 |
| AF     |         0 | **0.511** |         0 |         0 |          0 |          0 |
| BMI    |         0 |         0 | **0.893** |         0 |          0 |          0 |
| CRF    |         0 |         0 |         0 |         0 |  **1.000** |          0 |
| DBP    | **0.758** |         0 |         0 |         0 |          0 |          0 |
| eGFR   |         0 |         0 |         0 |         0 | **-0.144** |          0 |
| HDL    |         0 |         0 |         0 |         0 |          0 |  **0.818** |
| HF     |         0 | **0.970** |         0 |         0 |          0 |          0 |
| HTN    | **1.410** |         0 |         0 |         0 |          0 |          0 |
| SBP    | **0.733** |         0 |         0 |         0 |          0 |          0 |
| STROKE |         0 | **0.701** |         0 |         0 |          0 |          0 |
| T2D    |         0 |         0 |         0 | **1.617** |          0 |          0 |
| TG     |         0 |         0 |         0 |         0 |          0 | **-0.764** |
| TROPO  |         0 | **0.364** |         0 |         0 |          0 |          0 |
| WC     |         0 |         0 | **1.123** |         0 |          0 |          0 |
...
| Factor    | Trait pattern               |
| --------- | --------------------------- |
| BP        | DBP, HTN, SBP               |
| CARDIO    | AF, HF, STROKE, TROPO       |
| ADIPOSITY | BMI, WC                     |
| GLYCEMIC  | A1C, T2D                    |
| RENAL     | CRF positive, eGFR negative |
| LIPID     | HDL positive, TG negative   |
